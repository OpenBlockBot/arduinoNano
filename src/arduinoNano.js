...
class OpenBlockArduinoNanoDevice {
    ...
    get ANALOG_PINS_MENU () {
        return [
            ...
            {text: 'A4', value: Pins.A4},
            {text: 'A5', value: Pins.A5},
            {text: 'A6', value: Pins.A6},
            {text: 'A7', value: Pins.A7}
        ];
    }
            ...
            },
            {
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoNano.serial.serialReadAByte',
                            default: 'serial read a byte',
                            description: 'arduinoNano serial read a byte'
                        }),
                        blockType: BlockType.REPORTER,
                        disableMonitor: true,
                        programMode: [ProgramModeType.UPLOAD]
...
export default OpenBlockArduinoNanoDevice;
